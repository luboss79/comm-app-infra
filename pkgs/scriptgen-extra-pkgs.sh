...
# EPEL pkgs
echo "sudo yum install -y $epel_pkgs" >> linux-extra-pkgs.sh

# PHP pkgs
echo "sudo yum install -y $remi_pkgs" >> linux-extra-pkgs.sh

# Mysql pkgs
echo "sudo yum install -y $percona_pkgs" >> linux-extra-pkgs.sh

# Influxdb - telegraf pkgs
echo "sudo yum install -y $influxdb_pkgs" >> linux-extra-pkgs.sh

# IUS - mongodb
echo "sudo yum install -y $ius_pkgs" >> linux-extra-pkgs.sh
